...
public class EnderecoRemetente {
    ...
    public EnderecoRemetente(Long id, String nomeRua, String numeroCasa, String bairro, String cidade, String estado, int cep,
            String complemento) {
        this.id = id;
    ...
    public EnderecoRemetente(EnderecoDto enderecoDto) {
